...
Declare_Any_Class( "Bee",  // An example of drawing a hierarchical object using a "model_transform" matrix and post-multiplication.
  { 'construct'( context )
      { var shapes = { "box" : new        Cube(), 
        ...
        /*
        function draw_leg(leg_start) {
          leg_start = mult(leg_start, rotation(45*Math.abs(Math.sin(t/1000)), 1, 0, 0))
          model_transform = mult(leg_start, rotation(45, 1, 0, 0));
          model_transform = mult(model_transform, translation(0, 0.1, 1));
          model_transform = mult(model_transform, scale(0.2, 0.1, 1));
          this.shapes.box.draw(graphics_state, model_transform, this.yellow_clay);
          model_transform = leg_start;
          model_transform = mult(model_transform, translation(0, -2* 0.7071068, 2* 0.7071068));
          model_transform = mult(model_transform, rotation(-45*Math.abs(Math.sin(t/1000)), 1, 0, 0));
          model_transform = mult(model_transform, translation(0, -1, 0.1))
          model_transform = mult(model_transform, scale(0.2, 1, 0.1));
          this.shapes.box.draw(graphics_state, model_transform, this.yellow_clay);
        }
        */
        ...
        this.define_data_members( {  purplePlastic: context.shaders_in_use["Phong_Model" ].material( Color( .9,.5,.9, 1 ), .4, .4, .8, 40 ),
                                     ...
                                     red : context.shaders_in_use["Phong_Model"].material( Color(1.0,  0.0,  0.0,  1.0),  .4, .4, .8, 40),
                                     green : context.shaders_in_use["Phong_Model"].material( Color(  0.0,  1.0,  0.0,  1.0),  .4, .4, .8, 40),
                                     blue : context.shaders_in_use["Phong_Model"].material( Color(0.0,  0.0,  1.0,  1.0),  .4, .4, .8, 40),
    ...
    'display'( graphics_state )
      { 
          ...
          var t = graphics_state.animation_time/2;
          ...
          //this.shapes.box.draw(graphics_state, model_transform, this.purplePlastic);

          
          //plane
          model_transform = mult(model_transform, translation(0, -5, 0));
          model_transform = mult(model_transform, scale(50, 0.1, 50));
          this.shapes.box.draw(graphics_state, model_transform, this.greyPlastic);
          model_transform = mult(model_transform, scale(1/50, 1/0.1, 1/50));
          ...
          model_transform = mult(model_transform, scale(0.2, 0.6, 0.2));
          this.shapes.box.draw(graphics_state, model_transform, this.green);
          model_transform = mult(model_transform, scale(1/0.2, 1/0.6, 1/0.2))


          //sway
          for (var i = 0; i < 7; i++) {
             model_transform = mult(model_transform, translation(0, 0.6, 0))
            model_transform = mult(model_transform, rotation(4*Math.cos(t/1000), 0, 0, 0.3))
             model_transform = mult(model_transform, translation(0, 0.6, 0))
              model_transform = mult(model_transform, scale(0.2, 0.6, 0.2))
             this.shapes.box.draw(graphics_state, model_transform, this.green);
              model_transform = mult(model_transform, scale(1/0.2, 1/0.6, 1/0.2))
          ...
          this.shapes.ball.draw(graphics_state, model_transform, this.red);
         ...
         //this.shapes.box.draw(graphics_state, model_transform, this.purplePlastic);
          model_transform = mult(rotation( t/50, 0, 1, 0 ), translation( 0, Math.cos(t/1000), -6) );
          ...
          this.shapes.ball.draw(graphics_state, model_transform, this.purplePlastic);
          ...
          model_transform = mult(model_transform, translation(5, 0, 0))
          model_transform = mult(model_transform, scale(3, 1.5, 1.5));
          this.shapes.ball.draw(graphics_state, model_transform, this.brown_clay);
          model_transform = mult(model_transform, scale(1/3, 1/1.5, 1/1.5));


          model_transform = mult(model_transform, translation(-5, 1, 1));
          var left_wing_pt = model_transform;
          //right wing
          model_transform = mult(model_transform, rotation(30*Math.cos(t/1000), 1, 0, 0))
          model_transform = mult(model_transform, translation(0, 0.1, 3));
          model_transform = mult(model_transform, scale(1, 0.1, 3));
          this.shapes.box.draw(graphics_state, model_transform, this.yellow_clay);
          model_transform = mult(model_transform, scale(1, 1/0.1, 1/3));
          model_transform = mult(model_transform, translation(0, -0.1, -3));
          model_transform = mult(model_transform, rotation(-30*Math.cos(t/1000), 1, 0, 0));
          ...
          //draw legs
          //leg1
          model_transform = left_wing_pt;
          leg1_start = mult(left_wing_pt, translation (0, -2, 0));
          leg_start = mult(leg1_start, rotation(45*Math.abs(Math.sin(t/1000)), 1, 0, 0))
          model_transform = mult(leg_start, rotation(45, 1, 0, 0));
          model_transform = mult(model_transform, translation(0, 0.1, 1));
          model_transform = mult(model_transform, scale(0.2, 0.1, 1));
          this.shapes.box.draw(graphics_state, model_transform, this.yellow_clay);
          ...
          //leg 2
          leg2_start = mult(leg1_start, translation (1, 0, 0));
          leg_start = mult(leg2_start, rotation(45*Math.abs(Math.sin(t/1000)), 1, 0, 0))
          model_transform = mult(leg_start, rotation(45, 1, 0, 0));
          model_transform = mult(model_transform, translation(0, 0.1, 1));
          model_transform = mult(model_transform, scale(0.2, 0.1, 1));
          this.shapes.box.draw(graphics_state, model_transform, this.yellow_clay);
          ...
          //leg 3
          leg3_start = mult(leg1_start, translation (-1, 0, 0));
          leg_start = mult(leg3_start, rotation(45*Math.abs(Math.sin(t/1000)), 1, 0, 0))
          model_transform = mult(leg_start, rotation(45, 1, 0, 0));
          model_transform = mult(model_transform, translation(0, 0.1, 1));
          model_transform = mult(model_transform, scale(0.2, 0.1, 1));
          this.shapes.box.draw(graphics_state, model_transform, this.yellow_clay);
          ...
          this.shapes.box.draw(graphics_state, model_transform, this.yellow_clay);
                    ...
                    //leg4
          leg4_start = mult(leg1_start, translation (0, 0, -2));
          leg4_start = mult(leg4_start, rotation(180, 0, 1, 0));
          leg_start = mult(leg4_start, rotation(45*Math.abs(Math.sin(t/1000)), 1, 0, 0))
          model_transform = mult(leg_start, rotation(45, 1, 0, 0));
          model_transform = mult(model_transform, translation(0, 0.1, 1));
          model_transform = mult(model_transform, scale(0.2, 0.1, 1));
          this.shapes.box.draw(graphics_state, model_transform, this.yellow_clay);
          ...
          leg5_start = mult(leg4_start, translation (1, 0, 0));
          leg_start = mult(leg5_start, rotation(45*Math.abs(Math.sin(t/1000)), 1, 0, 0))
          model_transform = mult(leg_start, rotation(45, 1, 0, 0));
          model_transform = mult(model_transform, translation(0, 0.1, 1));
          ...
          leg6_start = mult(leg4_start, translation (-1, 0, 0));
          leg_start = mult(leg6_start, rotation(45*Math.abs(Math.sin(t/1000)), 1, 0, 0))
          model_transform = mult(leg_start, rotation(45, 1, 0, 0));
          model_transform = mult(model_transform, translation(0, 0.1, 1));
          model_transform = mult(model_transform, scale(0.2, 0.1, 1));
          this.shapes.box.draw(graphics_state, model_transform, this.yellow_clay);
          ...
          graphics_state.camera_transform = lookAt( [-25,0,0], [0,0,0], [0,1,0] ); 
  ...
  Declare_Any_Class( "Bee_Scene",  
  { 'construct'( context )
      { var shapes = { 
						'cone' : new Closed_Cone(10,10),
						'triangle'        : new Triangle(),
						'cylinder' : new Capped_Cylinder(4,25),
						"box" : new        Cube(), 
        ...
        this.define_data_members( { purplePlastic: context.shaders_in_use["Phong_Model" ].material( Color( .9,.5,.9, 1 ), .4, .4, .8, 40 ),
                                    ...
                                    black    : context.shaders_in_use["Phong_Model" ].material( Color( 0, 0, 0, 0), .4, .8, .4, 40 ),
									catuar: context.shaders_in_use["Phong_Model"  ].material( Color( 0.5, 0.5, 0.5, 0.5 ), .5, .5, .5, 40, context.textures_in_use["green.png"] ),
									night: context.shaders_in_use["Phong_Model"  ].material( Color( 0.5, 0.5, 0.5, 0.5 ), .5, .5, .5, 40, context.textures_in_use["night.png"] ),
									sun: context.shaders_in_use["Phong_Model"  ].material( Color( 0.5, 0.5, 0.5, 0.5 ), .5, .5, .5, 40, context.textures_in_use["sun.png"] ),
									pyramid: context.shaders_in_use["Phong_Model"  ].material( Color( 0.5, 0.5, 0.5, 0.5 ), .5, .5, .5, 40, context.textures_in_use["py.png"] ),
									dessert: context.shaders_in_use["Phong_Model"  ].material( Color( 0.5, 0.5, 0.5, 0.5 ), .5, .5, .5, 40, context.textures_in_use["dessert.png"] )
									}
								 ); 
      },
      'init_keys'( controls )
    ...
    'display'( graphics_state )
      { var model_transform = identity();             // We have to reset model_transform every frame
        ...
        graphics_state.lights = [ new Light( vec4(  30,  30,  34, 1 ), Color( 0, .4, 0, 1 ), 100000 ),
         ...
         var time_since_scene1_start = graphics_state.animation_time - 2000;
   
         var time_since_s2_start = time_since_scene1_start - 4000;

         var time_since_s3_start  = time_since_scene1_start - 7000;

         var time_since_s4_start  = time_since_scene1_start - 10500;

         var time_since_s5_start = time_since_scene1_start - 12500;

     

        
         if (time_since_scene1_start > 0) {
         		graphics_state.camera_transform = lookAt( [25 * Math.sin(time_since_s2_start/700), 22,30], [0, -5,0], [0,1,0] ); 
         } 

    
          if (time_since_scene1_start > 3000) {
         	graphics_state.camera_transform = lookAt( [0,0,80], [0,0,0], [0,1,0] );  
         } 


        //this.shapes.py.draw(graphics_state, model_transform, this.stars);

         model_transform = mult(model_transform, scale(500, 500, 500)); 
         this.shapes.ball.draw(graphics_state, model_transform, this.night);

         model_transform = mult(identity(), translation(0, -10, 0));
         model_transform = mult(model_transform, scale(500, 0.1, 500)); 
         this.shapes.box.draw(graphics_state, model_transform, this.dessert);

         model_transform = identity();

          //left leg base
          model_transform = mult(model_transform, translation(-2.3, -5.3, 0));
		  
		   
		 if (time_since_s2_start > 3000)  {
     	 	 time_since_s2_start = 0;
     	 	}
     	 //	graphics_state.camera_transform = lookAt( [45*Math.sin(time_since_s2_start/700), 22,30], [0, -5,0], [0,1,0] );
     	 
     	 if (time_since_s2_start >= 0)  {
     	 	 model_transform = mult(model_transform, rotation(45*Math.abs(Math.sin(time_since_s2_start/500)), 0, 0, 1));

     	 	}


     	 if (time_since_s3_start > 0)  {
     	 	if (time_since_s3_start > 4700) {
     	 		time_since_s3_start = 4700;
     	 	}

     	 	 var x = -(time_since_s3_start/100);
     		 model_transform = mult(model_transform, translation(x, 0, 0));
     		 graphics_state.camera_transform = lookAt( [0,0,60], [-30,0,0], [0,1,0] );  

     	 	}

     	  if (time_since_s4_start > 5000) {
     			time_since_s4_start = -1;
     	 }

     	 if (time_since_s4_start > 0) {
     	 	  var y = 10* Math.abs(Math.sin(time_since_s4_start/500));
     		  model_transform = mult(model_transform, translation(0, y, 0));
     	 }
    	 

     	 if (time_since_s5_start > 0) {
  			 graphics_state.camera_transform = lookAt( [-80,0,100], [-80,0,0], [0,1,0]);
     	 }

     	 if (time_since_s5_start > 3000) {
  			model_transform = mult(model_transform, rotation(-t, 0, 1, 0));
    	    model_transform = mult(model_transform, rotation(45, 0, 0, 1));
     	 }
    	 
  
          
          model_transform = mult(model_transform, translation(2.3, 2.3, 0));

          model_transform = mult(model_transform, rotation(-90, 0, 1, 0));
          model_transform = mult(model_transform, translation(0, 0, 1.5));
          model_transform = mult(model_transform, scale(.2, .2, 1.5));
          this.shapes.cylinder.draw(graphics_state, model_transform, this.catuar);
          model_transform = mult(model_transform, scale(1/.2, 1/.2, 1/1.5));
          model_transform = mult(model_transform, translation(0, 0, -1.5));
          model_transform = mult(model_transform, rotation(90, 0, 1, 0));


          model_transform = mult(model_transform, translation(-2.3, -1.3, 0));
          model_transform = mult(model_transform, rotation(-90, 1, 0, 0));	
          model_transform = mult(model_transform, scale(.2, .2, 2.5));
          this.shapes.cylinder.draw(graphics_state, model_transform, this.catuar);
          model_transform = mult(model_transform, scale(1/.2, 1/.2, 1/2.5));
          model_transform = mult(model_transform, rotation(90, 1, 0, 0));	
          model_transform = mult(model_transform, translation(2.3, 1.3, 0));


          model_transform = mult(model_transform, translation(0.5, 3, 0));
			
          //model_transform = mult(model_transform, translation(-3));

          //body
          //model_transform = mult(model_transform, rotation(30, 0, 0, 1));
         
          //hairs
          model_transform = mult(model_transform, translation(0.55, 3, 0));
          model_transform = mult(model_transform, scale(0.2, 1.2, 0.2));
          this.shapes.py.draw(graphics_state, model_transform, this.blue);
          model_transform = mult(model_transform, scale(1/0.2, 1/1.2, 1/0.2));
          model_transform = mult(model_transform, translation(-0.55, -3, -0));
          ...
          //left eye
          model_transform = mult(model_transform, translation(0.55, 1.6, 0.5));
          model_transform = mult(model_transform, scale(0.3, 0.3, 1));
          this.shapes.cylinder.draw(graphics_state, model_transform, this.black);
          model_transform = mult(model_transform, scale(1/0.3, 1/0.3, 1));
          model_transform = mult(model_transform, translation(-0.55, -1.6, -0.5));
          ...
          model_transform = mult(model_transform, scale(0.3, 0.3, 0.6));
       	  model_transform = mult(model_transform, translation(0, -2, 1));
          this.shapes.ball.draw(graphics_state, model_transform, this.black);
          ...
          this.shapes.cylinder.draw(graphics_state, model_transform, this.black);
          model_transform = mult(model_transform, scale(1, 1, 1/4));
          model_transform = mult(model_transform, rotation(-90, 1, 0, 0));
          model_transform = mult(model_transform, translation(0, 0, -1));
          model_transform = mult(model_transform, scale(1/0.3, 1/0.3, 1/0.6));
		
		  //trunk
		  model_transform = mult(model_transform, translation(0, -0.2, 0));
		  model_transform = mult(model_transform, scale(1.3, 1.2, 1));
       	  model_transform = mult(model_transform, translation(0, -2, 0));
          this.shapes.ball.draw(graphics_state, model_transform, this.catuar);
         ...
         model_transform = mult(model_transform, rotation(360*Math.cos(t/1000), 1, 0, 0));
        

          if (time_since_scene1_start > 7000) {
         	model_transform = mult(model_transform, rotation(-360*Math.cos(t/1000), 1, 0, 0));
         } 
          ...
          model_transform = mult(model_transform, translation(-2.5, 0.5, 0));
          model_transform = mult(model_transform, rotation(-90, 1, 0, 0));	
          model_transform = mult(model_transform, scale(.2, .2, 1.5));
          this.shapes.cylinder.draw(graphics_state, model_transform, this.catuar);
          model_transform = mult(model_transform, scale(1/.2, 1/.2, 1/1.5));
          ...
          //right leg
           model_transform = mult(model_transform, translation(0.8, -1.8, 0));
          ...
          model_transform = mult(model_transform, translation(30, 20, 0));
          model_transform = mult(model_transform, scale(5, 5, 5)); 
          this.shapes.ball.draw(graphics_state, model_transform, this.sun);


          //pyramid
          model_transform = identity();

          model_transform = mult(model_transform, translation(-100, -5, 0));
          model_transform = mult(model_transform, scale(10, 10, 10)); 
          this.shapes.py.draw(graphics_state, model_transform, this.pyramid );
          model_transform = mult(model_transform, scale(1/10, 1/10, 1/10));


          model_transform = mult(model_transform, translation(6.5, 27, 0));
         ...
         // ===========================================================================
          ...
          model_transform = mult(model_transform, translation(0.55, 3, 0));
          model_transform = mult(model_transform, scale(0.2, 1.2, 0.2));
          this.shapes.py.draw(graphics_state, model_transform, this.brown_clay);
          model_transform = mult(model_transform, scale(1/0.2, 1/1.2, 1/0.2));
          model_transform = mult(model_transform, translation(-0.55, -3, -0));

          model_transform = mult(model_transform, translation(0, 3, 0));
          model_transform = mult(model_transform, scale(0.2, 1.2, 0.2));
          this.shapes.py.draw(graphics_state, model_transform, this.brownPlastic);
          model_transform = mult(model_transform, scale(1/0.2, 1/1.2, 1/0.2));
          model_transform = mult(model_transform, translation(0, -3, -0))
